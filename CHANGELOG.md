...
## [2.4.2] — 2026-08-20
### Changed
- **กราฟประวัติอ่านง่ายขึ้นมาก** — จากเดิมวาด 7 เส้นปนกันในแกนเดียว (แต่ละเส้น normalize สเกลตัวเอง ไม่มีแกน y อ่านค่าจริงไม่ได้) → **แยกเป็น 5 แผงตามหน่วย**: ความชื้น % / อุณหภูมิ °C / EC dS/m / pH / N·P·K mg/kg — แต่ละแผงมีแกน y + หน่วย + วงสีกำกับของตัวเอง, ค่าล่าสุดติดขอบขวาแผงตัวเอง (ไม่ซ้อนกัน), เวลาใช้แกนเดียวกัน ดูเปรียบเทียบแนวโน้มได้
