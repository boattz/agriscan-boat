...
- **หน้าจอค้าง "กำลังโหลดประวัติ…" ตลอดถ้าการ์ดพัง** — `fetchHistory()` เดิมเรียก `drawHistory()` นอก try/catch ถ้าวาดพลาด overlay โหลดจะไม่หาย → ครอบ try/catch แสดง error (เปิด Console F12 ดูรายละเอียด) แทนการค้าง
