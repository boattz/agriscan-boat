    ...
    <div class="history-card">
      <div class="history-toolbar">
        <div class="history-legend">
          ...
          <span class="legend-item" style="--lg:#a855f7;"><i></i>pH</span>
          <span class="legend-item" style="--lg:#f472b6;"><i></i>N (mg/kg)</span>
          <span class="legend-item" style="--lg:#fbbf24;"><i></i>P (mg/kg)</span>
          <span class="legend-item" style="--lg:#60a5fa;"><i></i>K (mg/kg)</span>
        </div>
